...
for year2do = 2007 %2003:2004 %2011, 2005
dotime = 1; %0 = NO, 1 = YES
domerge = 0;
doclassify = 0;
doplotgroup = 0;
...
classplotflag = 1; %for classify: 0 = no plots, 1 = plots
movieflag = 0;
beadmovieflag=0;
...
if doclassify,
    ...
    if dobeads,
        ...
        beadbatch6M
        %beadbatch6_field %temp test for bead movies July 11, 2016
    end;
    if docells,
        filetypelist = cellfiletypelist;
        cellbatch8d_field
...
if movieflag
    groupedpath = [baseprocpath 'grouped\']; 
    mergedpath = [baseprocpath 'grouped\merged\'];
    savepath = '\\sosiknas1\Lab_data\MVCO\FCB\MVCO_movies\';
