function [smu, new_mu_est, no_new_est]=replace_suspicious_mus(time_mu,daily_mu,extraflag,plotflag)
...
if extraflag==1 %if want to see what second best likelihood returned!
    no_new_est=[];
    new_mu_est=[];
