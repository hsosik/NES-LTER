...
%Input SSCbu is a vector of Side Scatter values from observations in the
%flow cytometer divided by teh corresponding beadmatch values. 
% in our data this is usually 'merged{hour}(:,5) ./ beadmatch(hour)'

%Output cellvol is the volume of these observed cells in microliters. 
