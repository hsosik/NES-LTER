...
clear all; close all;
metadata_loc = '\\sosiknas1\IFCB_data\NESLTER_broadscale\metadata\Sharp_Nov2018\HRS1809JP\SMS\';
filelist = dir([metadata_loc, '*.txt']);
Date = [];
Time = [];
lat =[];
lon = [];
...
%temp2= temp2(:,1:9);
temp = char(Date([1:88625 88627:end]));%special case for bad
%data in second elg file of GGMAy2016 data.
temp2= char(Time([1:88625 88627:end]));
lat = lat([1:88625 88627:end]);
lon = lon([1:88625 88627:end]);
...
longitude = lon;
matlab_date = date;
%save \\sosiknas1\IFCB_data\NESLTER_broadscale\metadata\Sharp_Nov2018\metadata_raw matlab_date latitude longitude hour minute second day month year;
