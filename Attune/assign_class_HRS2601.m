function [ class , bounds] = assign_class_HRS2601( fcsdat, fcshdr, plot_flag, filename, QC_flag, startdate )
...
%Initialze class vector
    ...
    syneukBL3H2SSCHslope = 1; %1.2; %CHL to SSC
    syneukBL3H2SSCHoffset = -.6; %-.6; %PE to CHL -.8 on TN This was -1.7 AR88
    nonsynfactorA = 15; %6
    nonsynfactorB = 6; %2.5
