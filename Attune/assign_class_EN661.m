function [ class , bounds] = assign_class_EN661( fcsdat, fcshdr, plot_flag, filename, QC_flag, startdate )
...
%Initialze class vector
    ...
    gl2_noise_thresh = 20000; %basically synminY
    ...
    class(in_nonsyn_hiPE) = 4;
    class(class == 3 & fcsdat(:, npar_synY) > 5e5) = 4; 
