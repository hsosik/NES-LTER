%Copy of process_beads_PT_adjust_2 modified to just run on Discrete between
%cruise bead runs 
...
fpath = '\\sosiknas1\Lab_data\Attune\cruise_data\beads\FCB_bead_mix_experiment_settings\between_cruises\' ; 
outpath = [fpath filesep 'outputs' ]; 
...
beadlist = dir([fpath filesep '*.fcs']); 
beadlist = {beadlist.name}; 
...
% save beadstat
beadstat = beadstat_2021; 
save([outpath filesep 'beadstat'],'beadstat', 'notes', 'beadtype', 'bead_ch_names')
