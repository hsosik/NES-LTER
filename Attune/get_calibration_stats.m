...
function get_calibration_stats(outpath, classpath, stepsize, DIM)
 ...
 classlist = dir([classpath, '*.mat']); 
    ...
    elseif DIM == 'H'
        ...
        ind_to_fit = find(gl1_vals>l_bound & gl1_vals<r_bound); %not a super robust way to choose the range to fit
         ...
         LM = fitlm(log10(gl1_vals(ind_to_fit)), log10(ssc_value(ind_to_fit)));     
    ...
    joint_table = [joint_table; calibrate_info];
        ...
        loglog(gl1_vals(ind_to_fit), ssc_value(ind_to_fit), 'r.')
