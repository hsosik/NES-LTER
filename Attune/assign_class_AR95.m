 function [ class , bounds] = assign_class_AR95( fcsdat, fcshdr, plot_flag, filename, QC_flag, startdate )
...
%     end
    ...
    pro_2nd_gate = [400 0; 400 800; 8000 8000; 8000 0]; %gates Pro on GL2/SSC plot - lower limits need to match ProminX
    end
